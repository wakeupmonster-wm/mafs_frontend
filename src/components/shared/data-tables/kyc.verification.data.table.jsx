...
export default function KYCVerificationDataTable({
  ...
  const hasActiveFilters = filters.statusFilter || filters.sortBy;
                ...
                >
                  ...
                  {["pending", "approved", "rejected"].map((status) => (
                    <DropdownMenuCheckboxItem
                      ...
                      onCheckedChange={() => filters.setStatusFilter(status)} // This triggers setStatusFilter in the page
                  ...
                  {[
                    ...
                    <DropdownMenuCheckboxItem
                      ...
                      onCheckedChange={() => filters.setSortBy(opt.id)} // This triggers setSortBy in the page
                    >
                      {opt.label}
                    </DropdownMenuCheckboxItem>
                  ))}
                  ...
                  {(filters.statusFilter || filters.sortBy) && (
                    <>
                      ...
                      <DropdownMenuItem
                        ...
                        onClick={() => {
                          filters.setStatusFilter(""); // Resets status
                          filters.setSortBy(""); // Resets sort
                        }}
                      >
                        Clear All Filters
                      </DropdownMenuItem>
