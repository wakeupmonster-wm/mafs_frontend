...
export default function PrizesDataTable({
  columns,
  data,
  rowCount,
  pagination,
  ...
  const hasActiveFilters = filters.prizeType;
          ...
          <div className="flex items-center justify-end gap-3 min-w-0 flex-1 ml-4">
            ...
            <div className="shrink-0">
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  align="end"
                  className="w-44 p-2 shadow-xl border-slate-200"
                >
                  ...
                  {["GIFT_CARD", "FREE_PREMIUM"].map((status) => (
                    <DropdownMenuCheckboxItem
                      ...
                      checked={filters.prizeType === status}
                      onCheckedChange={() => filters.setPrizeType(status)}
                    >
                      {status}
                    </DropdownMenuCheckboxItem>
                  ))}
            ...
            {hasActiveFilters && (
              ...
              >
                {filters.prizeType && (
                  ...
                  >
                    Status:
                    <span className="capitalize ml-1">{filters.prizeType}</span>
                    <button
                      onClick={() => filters.setPrizeType("")}
                      className="ml-1"
                    >
