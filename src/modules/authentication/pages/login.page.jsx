...
export default function LoginPage() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 w-full h-screen">
      ...
      <div className="flex items-center justify-center p-6 sm:p-12 lg:p-24 bg-slate-50/50">
        <div className="w-full max-w-md">
          <div className="w-full bg-white border border-slate-200 rounded-[2.5rem] shadow-2xl shadow-slate-200/60 p-8 sm:p-12">
            <LoginForm />
          </div>
        </div>
      </div>
