...
//                     <td colSpan={6} className="px-6 py-16 text-center">
//                       <div className="flex flex-col items-center gap-4">
//                         <div className="p-4 bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl"></div>
//                         <div>
...
//                       <img
//                         src={item?.profilePhoto || "/placeholder-user.png"}
//                         alt="User"
//                         onClick={() =>
//                           setImageModal({
//                             open: true,
//                             src: item?.profilePhoto,
//                             title: item.nickname || "User Profile",
//                           })
//                         }
...
//                           !action ||
//                           (action === "reply" &&
//                             (!selectedReportId || !replyMessage.trim()))
//                         }
...
const LoadingSpinner = ({ message = "Loading..." }) => (
  <div className="flex flex-col items-center justify-center py-16 gap-4">
    <div className="relative w-20 h-20">
      ...
      <div className="absolute inset-2 border-4 border-t-blue-600 border-r-blue-400 border-b-blue-200 border-l-blue-400 rounded-full animate-spin"></div>
      {/* Inner pulsing circle */}
      <div className="absolute inset-4 bg-gradient-to-br from-blue-500 to-blue-600 rounded-full animate-pulse"></div>
      {/* Center icon */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
            ...
            <Card className="p-4 bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
              <div className="flex items-center justify-between">
                ...
                <Flag className="w-8 h-8 text-purple-500 opacity-50" />
              </div>
            </Card>
          </div>
                  ...
                  <tr>
                    <td colSpan={6}>
                      <div className="text-center py-16">
                        <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-emerald-100 to-emerald-200 rounded-full mb-4">
        ...
        <Card className="mt-6 p-4">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-sm text-gray-600">
              Showing {pagination?.page || page} of{" "}
              {pagination?.totalPages || 1} pages • {stats.total} total reports
            </p>
            <div className="flex items-center gap-2">
              <Button
                variant="outline"
        ...
        >
          ...
          >
            <div className="flex items-center justify-between p-4 border-b">
              <h3 className="font-semibold text-lg">{imageModal.title}</h3>
              <button
                onClick={() =>
                  setImageModal({ open: false, src: "", title: "" })
                }
...
export function ProfileReviewDetailPage({ userId }) {
  ...
  useEffect(() => {
    if (successMessage) {
      ...
      setTimeout(() => {
        dispatch(clearProfileReviewStatus());
      }, 3000);
    }
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      const actionMessages = {
        ...
        reject: "Profile rejected successfully!",
      ...
      setToast({
        type: "error",
        message: err?.message || "Failed to perform action. Please try again.",
      });
    } finally {
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-gray-100 pb-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <Card className="p-6 bg-red-50 border-red-200">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="font-medium text-red-900">{p.banReason}</p>
                  </div>
                  {p.banDetails?.banExpiresAt && (
                    <div>
                      <p className="text-sm text-red-600 mb-1">Expires On</p>
                      <p className="font-medium text-red-900">
                        {new Date(p.banDetails.banExpiresAt).toLocaleDateString(
                          "en-IN",
                          {
                            day: "numeric",
                            month: "long",
                  ...
                  {p.profile.photos.map((ph, idx) => (
                    ...
                    >
                      ...
                      <div className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-all duration-300 flex items-center justify-center">
                        <div className="opacity-0 group-hover:opacity-100 transition-opacity bg-white/90 px-3 py-1 rounded-full text-sm font-semibold">
                          #{idx + 1}
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    {r.adminReply && (
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-3">
                        ...
                        <p className="text-blue-800 mb-2">{r.adminReply}</p>
                        {r.repliedAt && (
          ...
          {/* Right Column - Action Panel (1/3 width) - Sticky */}
          <div className="lg:col-span-1">
              ...
              {p.status === "resolved" ? (
                <>
                  <div className="text-center mb-6">
                    ...
                    <p className="text-gray-600">Case Closed</p>
                  ...
                  <Link to="/admin/management/profile-review" className="block">
