...
export const getSubscriberColumns = (navigate) => [
    ...
    },
    {
        ...
        header: () => <div className="text-[10px] font-black uppercase tracking-widest text-slate-500">Plan</div>,
        cell: ({ row }) => {
            ...
            return (
                <Badge className={cn(
                    ...
                    plan === "1_MONTH" || plan === "MONTHLY" ? "bg-blue-50 text-blue-600 border-blue-100" :
                    plan === "3_MONTH" || plan === "QUARTERLY" ? "bg-indigo-50 text-indigo-600 border-indigo-100" :
    ...
    },
    {
        ...
        header: () => <div className="text-[10px] font-black uppercase tracking-widest text-slate-500">Platform</div>,
        cell: ({ row }) => {
            ...
            return (
                <Badge variant="outline" className={cn("text-[10px] font-black px-2 py-0.5 h-5 gap-1 shadow-none border", style)}>
                    {icon} {label}
                </Badge>
            );
        },
    ...
    },
    {
        ...
        header: () => <div className="text-[10px] font-black uppercase tracking-widest text-slate-500">Expires</div>,
        cell: ({ row }) => {
            ...
            return (
                <div className="space-y-0.5">
                    ...
                    )}>{date ? format(new Date(date), "MMM dd, yyyy") : "-"}</p>
                    <p className="text-[10px] text-slate-400">{date ? formatDistanceToNow(new Date(date), { addSuffix: true }) : "-"}</p>
                </div>
            );
        },
    },
    {
        ...
        header: () => <div className="text-[10px] font-black uppercase tracking-widest text-slate-500 text-center">Auto-Renew</div>,
        cell: ({ row }) => {
    ...
    {
        accessorKey: "source",
        header: () => <div className="text-[10px] font-black uppercase tracking-widest text-slate-500">Source</div>,
        cell: ({ row }) => {
