...
const AdminProfile = () => {
      ...
      if (token) {
        try {
          const response = await fetch(
            "http://localhost:3001/api/v1/admin/auth/profile",
            {
              headers: {
  ...
  const handleNameUpdate = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:3001/api/v1/admin/auth/profile/update-name",
        {
          method: "PUT",
          headers: {
      ...
      if (response.ok) {
        setAdminData((prev) => ({
          ...prev,
          fullName: nameForm.fullName.trim(),
        }));
        ...
        setNameForm((prev) => ({
          ...prev,
          error: data.message || "Failed to update name",
        }));
      }
    } catch (error) {
      setNameForm((prev) => ({
  ...
  const handleEmailSendOtp = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:3001/api/v1/admin/auth/profile/send-email-otp",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleEmailVerifyOtp = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:3001/api/v1/admin/auth/profile/verify-email-otp",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:3001/api/v1/admin/auth/reset-password",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleForgotPasswordSendOtp = async (e) => {
    ...
    if (
      ...
      !emailRegex.test(forgotPasswordForm.email)
    ) {
      setForgotPasswordForm((prev) => ({
        ...prev,
        error: "Please enter a valid email address",
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:3001/api/v1/admin/auth/send-email-otp",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  const handleForgotPasswordVerify = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:3001/api/v1/admin/auth/forgot-password",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
      ...
      if (response.ok) {
        setForgotPasswordForm({
          ...
          error: "",
          success:
            "Password reset successful! You can now use your new password.",
          isVerifying: false,
        });
              ...
              <div className="flex items-end gap-4">
                ...
                <div className="pb-2">
                  <h2 className="text-2xl font-bold text-slate-900">
                    {adminData.fullName || adminData.nickname || "Admin User"}
                  </h2>
                  <p className="text-slate-600 font-medium">
                    {adminData.email || "No email set"}
                  </p>
                  {adminData.phone && (
              ...
              {nameForm.isEditing ? (
                    ...
                    <Button
                      ...
                      onClick={() => {
                        setNameForm((prev) => ({
                          ...prev,
                          fullName:
                            adminData.fullName || adminData.nickname || "",
                          isEditing: false,
                          error: "",
                        }));
                      }}
                ...
                <div className="flex items-center gap-3 p-4 bg-slate-50 rounded-lg border-2 border-slate-200">
                  ...
                  <span className="font-semibold text-slate-900">
                    {adminData.fullName || adminData.nickname || "Not set"}
                  </span>
                </div>
              )}
            </CardContent>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <CardDescription className="font-medium">
                      Update your email with OTP verification
                    </CardDescription>
                  </div>
                </div>
                {!emailForm.isEditing && (
                    ...
                    <form onSubmit={handleEmailVerifyOtp} className="space-y-4">
                      <div className="p-4 bg-indigo-50 border-2 border-indigo-200 rounded-lg">
                        <p className="text-sm font-semibold text-indigo-900">
                          OTP sent to:{" "}
                          <span className="font-bold">{emailForm.email}</span>
                        </p>
                      </div>
                      <div>
                        <Label
                      ...
                      <div className="flex gap-3">
                        <Button
                          ...
                          disabled={
                            loading ||
                            emailForm.isVerifying ||
                            emailForm.otp.length !== 6
                          }
                          className="flex-1 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 font-semibold shadow-lg"
                        >
                          {emailForm.isVerifying
              ...
              {!forgotPasswordForm.otpSent ? (
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="relative mt-1">
                      <Input
                        ...
                        type={
                          forgotPasswordForm.showNewPassword
                            ? "text"
                            : "password"
                        }
                  ...
                  <div>
                    ...
                    <div className="relative mt-1">
                      <Input
                        ...
                        type={
                          forgotPasswordForm.showConfirmPassword
                            ? "text"
                            : "password"
                        }
                  ...
                  <Button
                    ...
                    disabled={
                      loading ||
                      forgotPasswordForm.isVerifying ||
