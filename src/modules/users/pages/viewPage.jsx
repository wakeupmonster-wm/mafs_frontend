...
import { DUMMY_USER } from "@/app/data/dummyData";
...
export default function ViewPage() {
  ...
  const userData = liveUser || initialUserData || DUMMY_USER;
        ...
        <Tabs defaultValue="profile">
          <TabsList className="grid grid-cols-4 w-full">
            ...
            <TabsTrigger value="media">
              <IconPhoto size={16} className="mr-2" /> Media
            </TabsTrigger>
            <TabsTrigger value="activity">
              <IconActivity size={16} className="mr-2" /> Activity
            </TabsTrigger>
            <TabsTrigger value="financial">
              <IconCreditCard size={16} className="mr-2" /> Financials
            </TabsTrigger>
          </TabsList>
        </Tabs>
