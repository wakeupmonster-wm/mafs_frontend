...
import { fetchPrivacyPolicy, updatePrivacyPolicy } from "../store/privacy.slice";
// import "./privacy-quill.css"; // We'll add some custom styling here

// export default function PrivacyAndPolicyPage() {
//   const [pageData, setPageData] = useState({
//     title: "Privacy Policy",
//     status: "Publish",
//     description: `<p>This privacy policy applies to the Match At First Swipe application...</p>`,
//   });
...
export default function PrivacyAndPolicyPage() {
  ...
  const modules = {
    toolbar: [
      // Heading sizes: 1, 2, 3, 4, 5, 6 and false (for normal text)
      [{ header: [1, 2, 3, 4, 5, 6, false] }],

      // Basic formatting
      ["bold", "italic", "underline", "strike"],

      // List options: ordered and bullet (unordered)
      // { list: "ordered" },
      [{ list: "bullet" }],

      // Script options for Privacy Policy legal text
      [{ script: "sub" }, { script: "super" }],

      // Link and Image (if needed)
      ["link", "image"],
